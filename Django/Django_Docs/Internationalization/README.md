...
A message file is a plain-text file, representing a single language, that contains all available *translation strings* (definition below) and how they should be represented in the given language. Message files have a `.po` file extension.
